...
Initialise
        ...
        LIBSCREEN_WRITE_VAA #12, title, $040E
        lda #$80
        sta MODE
        LIBGENERAL_STORE_ADDRESS_AA $0450, ScnAdr
        rts
...
InitialisePoem
        ...
        sta fl
        sta NewLine
        LIBGENERAL_GENERATE_8BIT_RAND_VVA #0, #2, mo
        LIBGENERAL_GENERATE_8BIT_RAND_VVA #4, #7, i
        rts
...
ChooseWords
        ...
        LIBGENERAL_GENERATE_8BIT_RAND_VVA #0, #9, av
Randaj  LIBGENERAL_GENERATE_8BIT_RAND_VVA #0, #9, aj
        cmp av
        beq Randaj
        ldy mo
...
;Choose lines
ChooseLines
        LIBGENERAL_GENERATE_8BIT_RAND_VVA #0, #10, poemPtr
...
AnotherPoem
        LIBSCREEN_WRITE_VAA #17, NewPoem, $0770
GetKey
        lda LASTKEY
        cmp charY
        beq Y
